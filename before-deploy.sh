...
# Generate keystore
sudo apt install tree -y && tree || ls -la $HOMEPATH/*
...
#./gradlew build
cp $HOMEPATH/play-services-core-release/build/outputs/apk/*-unsigned.apk $HOMEPATH/outputs/play-services-core-release.apk
